...
import 'package:budget/widgets/quick_add_transaction_card.dart';
      ...
      children: [
        ...
        StreamBuilder<List<TransactionCategory>>(
          ...
          builder: (context, snapshot) {
            ...
            return QuickAddTransactionCard(
              categories: categories,
              onApply: (parsed) {
                setSelectedTitle(parsed.title);
                setSelectedAmount(parsed.amount, parsed.amount.toString());
                setSelectedIncome(parsed.isIncome);
                if (parsed.matchedCategory != null) {
                  setSelectedCategory(parsed.matchedCategory!);
                }
              },
            );
          },
